...
var middlewareSecret = "9d06a4f2-a701-4e42-9a40-321f37f2ef50";
//#endregion
...
var _page0 = () => import("./chunks/generic_BPQ0WKhx.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/contact_DctN6luu.mjs");
...
var _manifest = deserializeManifest({"rootDir":"file:///C:/project/personal-web/","cacheDir":"file:///C:/project/personal-web/node_modules/.astro/","outDir":"file:///C:/project/personal-web/dist/","srcDir":"file:///C:/project/personal-web/src/","publicDir":"file:///C:/project/personal-web/public/","buildClientDir":"file:///C:/project/personal-web/dist/client/","buildServerDir":"file:///C:/project/personal-web/.vercel/output/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/contact","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/contact\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"contact","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/contact.ts","pathname":"/api/contact","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["C:/project/personal-web/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/api/contact@_@ts":"chunks/contact_DctN6luu.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_BPQ0WKhx.mjs","C:/project/personal-web/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_D1GUmIMm.mjs","@/components/sections/AboutContent":"_astro/AboutContent.Cp-MLyAT.js","C:/project/personal-web/src/components/custom/CertificateGallery.astro?astro&type=script&index=0&lang.ts":"_astro/CertificateGallery.astro_astro_type_script_index_0_lang.YmLuUh7P.js","@/components/forms/ContactForm":"_astro/ContactForm.CbQtUgQl.js","@/components/layout/Intro":"_astro/Intro.B9kft3gl.js","C:/project/personal-web/src/components/layout/Navbar.astro?astro&type=script&index=0&lang.ts":"_astro/Navbar.astro_astro_type_script_index_0_lang.hI3aElVU.js","@/components/magic-ui/Particles":"_astro/Particles.CHAyJA8Z.js","C:/project/personal-web/src/components/custom/ScrollTimeline.astro?astro&type=script&index=0&lang.ts":"_astro/ScrollTimeline.astro_astro_type_script_index_0_lang.DFbgI-t4.js","@astrojs/react/client.js":"_astro/client.DnM_O5Vj.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["C:/project/personal-web/src/components/custom/CertificateGallery.astro?astro&type=script&index=0&lang.ts","var e=class extends HTMLElement{items=[];selectors=[];previews=[];credentialLinks=[];suppressPointerPreviewUntilLeave=!1;connectedCallback(){this.items=Array.from(this.querySelectorAll(`[data-certificate-item]`)),this.selectors=Array.from(this.querySelectorAll(`[data-certificate-selector]`)),this.previews=Array.from(this.querySelectorAll(`[data-certificate-preview]`)),this.credentialLinks=Array.from(this.querySelectorAll(`[data-certificate-credential]`)),this.selectors.length!==0&&this.previews.length!==0&&(this.classList.add(`is-enhanced`),this.suppressPointerPreviewUntilLeave=!1,this.clearPreview(),this.items.forEach(e=>{e.addEventListener(`pointerenter`,this.handlePointerEnter),e.addEventListener(`pointerleave`,this.handlePointerLeave)}),this.selectors.forEach(e=>{e.addEventListener(`focus`,this.handleSelectorFocus),e.addEventListener(`blur`,this.handleSelectorBlur),e.addEventListener(`click`,this.handleSelectorClick)}),this.credentialLinks.forEach(e=>{e.addEventListener(`click`,this.handleCredentialClick)}),document.addEventListener(`visibilitychange`,this.handleVisibilityChange))}disconnectedCallback(){this.items.forEach(e=>{e.removeEventListener(`pointerenter`,this.handlePointerEnter),e.removeEventListener(`pointerleave`,this.handlePointerLeave)}),this.selectors.forEach(e=>{e.removeEventListener(`focus`,this.handleSelectorFocus),e.removeEventListener(`blur`,this.handleSelectorBlur),e.removeEventListener(`click`,this.handleSelectorClick)}),this.credentialLinks.forEach(e=>{e.removeEventListener(`click`,this.handleCredentialClick)}),document.removeEventListener(`visibilitychange`,this.handleVisibilityChange),this.classList.remove(`is-enhanced`)}handlePointerEnter=e=>{if(this.suppressPointerPreviewUntilLeave)return;let t=e.currentTarget;if(!(t instanceof HTMLElement))return;let n=t.dataset.certificateId;n&&this.showPreview(n)};handlePointerLeave=e=>{let t=e.currentTarget;t instanceof HTMLElement&&(this.suppressPointerPreviewUntilLeave=!1,t.querySelector(`[data-certificate-selector]:focus`)||this.clearPreview())};handleSelectorFocus=e=>{let t=e.currentTarget;if(!(t instanceof HTMLButtonElement))return;this.suppressPointerPreviewUntilLeave=!1;let n=t.dataset.certificateId;n&&this.showPreview(n)};handleSelectorBlur=e=>{let t=e.currentTarget;t instanceof HTMLButtonElement&&(t.closest(`[data-certificate-item]`)?.matches(`:hover`)||this.clearPreview())};handleSelectorClick=e=>{let t=e.currentTarget;if(!(t instanceof HTMLButtonElement))return;this.suppressPointerPreviewUntilLeave=!1;let n=t.dataset.certificateId;n&&this.showPreview(n)};handleCredentialClick=()=>{this.clearPreview(!0)};handleVisibilityChange=()=>{document.hidden&&this.clearPreview(!0)};showPreview(e){this.previews.some(t=>t.dataset.certificateId===e)&&(this.dataset.previewActive=e,this.selectors.forEach(t=>{let n=t.dataset.certificateId===e;t.setAttribute(`aria-pressed`,String(n)),t.closest(`[data-certificate-item]`)?.classList.toggle(`is-active`,n)}),this.previews.forEach(t=>{let n=t.dataset.certificateId===e;t.classList.toggle(`is-active`,n),n?t.removeAttribute(`aria-hidden`):t.setAttribute(`aria-hidden`,`true`)}))}clearPreview(e=!1){e&&(this.suppressPointerPreviewUntilLeave=!0),delete this.dataset.previewActive,this.selectors.forEach(e=>{e.setAttribute(`aria-pressed`,`false`),e.closest(`[data-certificate-item]`)?.classList.remove(`is-active`)}),this.previews.forEach(e=>{e.classList.remove(`is-active`),e.setAttribute(`aria-hidden`,`true`)})}};customElements.get(`certificate-gallery`)||customElements.define(`certificate-gallery`,e);"],["C:/project/personal-web/src/components/layout/Navbar.astro?astro&type=script&index=0&lang.ts","var e=window.matchMedia(`(min-width: 48rem)`);document.querySelectorAll(`[data-navbar]`).forEach(t=>{let n=t.querySelector(`[data-menu-toggle]`),r=t.querySelector(`[data-menu-links]`),i=t.querySelectorAll(`[data-menu-link]`);if(!n||!r)return;t.dataset.menuReady=`true`;let a=(i,a=!1)=>{let o=!e.matches,s=o&&i;t.dataset.menuOpen=String(s),n.setAttribute(`aria-expanded`,String(s)),n.setAttribute(`aria-label`,s?`Close navigation menu`:`Open navigation menu`),o&&!s?(r.setAttribute(`aria-hidden`,`true`),r.setAttribute(`inert`,``)):(r.setAttribute(`aria-hidden`,`false`),r.removeAttribute(`inert`)),a&&n.focus()};n.addEventListener(`click`,()=>{a(n.getAttribute(`aria-expanded`)!==`true`)}),i.forEach(e=>{e.addEventListener(`click`,()=>a(!1))}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&n.getAttribute(`aria-expanded`)===`true`&&a(!1,!0)}),e.addEventListener(`change`,()=>a(!1)),a(!1)});"],["C:/project/personal-web/src/components/custom/ScrollTimeline.astro?astro&type=script&index=0&lang.ts","var e=class extends HTMLElement{sectionObserver;revealObserver;animationFrame;motionQuery;progressRail=null;items=[];connectedCallback(){this.progressRail=this.querySelector(`.scroll-timeline__progress`),this.items=Array.from(this.querySelectorAll(`[data-timeline-item]`)),this.motionQuery=window.matchMedia(`(prefers-reduced-motion: reduce)`),this.motionQuery.addEventListener(`change`,this.handleMotionChange),this.applyMotionPreference()}disconnectedCallback(){this.cleanupEnhancement(),this.motionQuery?.removeEventListener(`change`,this.handleMotionChange)}handleMotionChange=()=>{this.applyMotionPreference()};applyMotionPreference(){if(this.cleanupEnhancement(),this.motionQuery?.matches||!(`IntersectionObserver`in window)||!this.progressRail){this.setStaticState();return}this.classList.remove(`is-static`),this.classList.add(`is-enhanced`),this.progressRail.style.transform=`scaleY(0)`,this.items.forEach(e=>e.classList.remove(`is-active`)),this.revealObserver=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&(e.target.classList.add(`is-revealed`),this.revealObserver?.unobserve(e.target))})},{rootMargin:`0px 0px -18% 0px`,threshold:.08}),this.items.forEach(e=>this.revealObserver?.observe(e)),this.sectionObserver=new IntersectionObserver(([e])=>{e?.isIntersecting?this.startProgressLoop():this.stopProgressLoop()},{rootMargin:`20% 0px`}),this.sectionObserver.observe(this)}setStaticState(){this.classList.remove(`is-enhanced`,`is-running`),this.classList.add(`is-static`),this.progressRail?.style.setProperty(`transform`,`scaleY(1)`),this.items.forEach(e=>{e.classList.add(`is-revealed`,`is-active`)})}startProgressLoop(){this.animationFrame===void 0&&(this.classList.add(`is-running`),this.updateProgress())}stopProgressLoop(){this.animationFrame!==void 0&&(window.cancelAnimationFrame(this.animationFrame),this.animationFrame=void 0),this.classList.remove(`is-running`)}updateProgress=()=>{let e=this.getBoundingClientRect(),t=window.innerHeight*.5,n=Math.min(Math.max((t-e.top)/e.height,0),1);this.progressRail&&(this.progressRail.style.transform=`scaleY(${n})`),this.items.forEach(e=>{let n=e.getBoundingClientRect(),r=n.top<=t&&n.bottom>=t;e.classList.toggle(`is-active`,r)}),this.animationFrame=window.requestAnimationFrame(this.updateProgress)};cleanupEnhancement(){this.sectionObserver?.disconnect(),this.revealObserver?.disconnect(),this.sectionObserver=void 0,this.revealObserver=void 0,this.stopProgressLoop()}};customElements.get(`scroll-timeline`)||customElements.define(`scroll-timeline`,e);"]],"assets":["/favicon.svg","/_astro/AboutContent.Cp-MLyAT.js","/_astro/client.DnM_O5Vj.js","/_astro/ContactForm.CbQtUgQl.js","/_astro/Intro.B9kft3gl.js","/_astro/jsx-runtime.DIiiIrYY.js","/_astro/Particles.CHAyJA8Z.js","/_astro/react.B3l9tXpq.js","/_astro/utils.SJsoOVwg.js","/_astro/sql_advanced_certificate.CgxY4Yq-.webp","/_astro/index.CcDDkxBr.css","/_astro/about-picture.GDIUbsmM.webp","/_astro/background-video-text.B6n80kLF.webm","/_astro/geist-cyrillic-ext-wght-normal.DjL33-gN.woff2","/_astro/geist-cyrillic-wght-normal.BEAKL7Jp.woff2","/_astro/geist-vietnamese-wght-normal.6IgcOCM7.woff2","/_astro/geist-latin-ext-wght-normal.DC-KSUi6.woff2","/_astro/geist-latin-wght-normal.BgDaEnEv.woff2","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"3DC7++7wA/YBHc8tTTUIdy5D1hZkKpR/pQu2fZFfcM8=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "9d06a4f2-a701-4e42-9a40-321f37f2ef50") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
